...
static const char selbordercolor[]  = "#6095C5";
...
static const char fancybarsep[]     = "> ";     /* String used to separate client titles in fancy bar */
...
static const Layout layouts[] = {
	...
	{ "[M]",      monocle },
	{ "[ ]=",     tilegap },    /* tiled layout with gaps */
};
...
static const char *nametagcmd[] = { "dmenu", "-fn", dmenufont};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_n,      nametag,        {.v = nametagcmd} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
